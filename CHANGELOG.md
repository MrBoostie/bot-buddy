...
- Added direct `thinkWithOpenClaw` retry-loop regression coverage for transient-failure recovery, retry-budget exhaustion, and non-retryable-failure short-circuit paths.
